...
def abrirSubmenuReportes(pVentana,pDonadores,pTiposSangre,pLugaresDonacion):
    ...
    crearBoton(ventanaReportes,"4.Lista completa de donadores",lambda:mostrarMensaje("Aquí irá reporteListaCompletaDonadores"))
    ...
    crearBoton(ventanaReportes,"9.Lugares de donación",lambda:mostrarMensaje("Aquí irá reporteLugaresDonacion"))
...
def menuPrincipal(pDonadores):
    ...
    crearBoton(ventana,"6.Reportes",lambda:abrirSubmenuReportes(ventana,pDonadores,tiposSangre,lugaresDonacion))
